...
async def mbti_genai_analysis(data, name):
    try:
        ...
        <p>🧠 {name}的MBTI是：<b>XXXX</b></p>

        <p>📊 分析如下：</p>
        <ul>
        <li><b>🔵 内向与外向（I/E）：</b> // 开头写I/E的结论，后面内容结合具体推文或简介的内容进行分析</li>
        <li><b>🟢 实感与直觉（S/N）：</b> // 开头写S/N的结论，后面内容结合具体推文或简介的内容进行分析</li>
        <li><b>🔴 思考与情感（T/F）：</b> // 开头写T/F的结论，后面内容结合具体推文或简介的内容进行分析</li>
        <li><b>🟡 判断与感知（J/P）：</b> // 开头写J/P的结论，后面内容结合具体推文或简介的内容进行分析</li>
        </ul>

        <hr>
        
        <b>🎉 和{name}有同样MBTI的名人 🎉</b>
        <p>✨ // 介绍一个相同MBTI的名人，写一句话的内容。</p>
